...
ROUTES = ROUTES + [
    ...
    Get().route("/users/verify-email", "ConfirmController@verify_show").name("verify"),
    Get().route("/users/verify-email/send", "ConfirmController@send_verify_email"),
    Get().route("/users/verify-email/@id:signed", "ConfirmController@confirm_email"),
    Get()
